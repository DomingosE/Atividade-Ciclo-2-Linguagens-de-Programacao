...
if LadoA > (LadoB+LadoC) or LadoB > (LadoA+LadoC) or LadoC > (LadoA+LadoB):
    print(f'\nSe somarmos os valores do lado "A" = {LadoA}, lado "B" = {LadoB}, e lado "C" = {LadoC} temos o valor total de {ValorTotal}. Esse valor total não forma um triângulo com valores positivos.')
